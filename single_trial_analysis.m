function [Az] = single_trial_analysis(X, truth, duration, skipLOO)
...
%       skipLOO (flag (0|1) for running the leave-one-out-crossvalidation)
%
% OUTPUT: 
%       Az (discriminator performance - this is a scalar between 0.5 and 1) 
